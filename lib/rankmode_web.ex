defmodule RankmodeWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: RankmodeWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/rankmode_web/templates",
        namespace: RankmodeWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {RankmodeWeb.LayoutView, "live.html"}
