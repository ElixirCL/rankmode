defmodule RankmodeWeb.Live.Components.Icons do

  use Phoenix.Component

  def customer_support(%{selected: true} = assigns) do
    ~H"""
  ...
  def customer_support(assigns) do
    ~H"""
  ...
  def credit_card(%{selected: true} = assigns) do
    ~H"""
